      ...
      <div v-if="round === null && !showExample">
        ...
        <p>
          <template v-if="lang === 'zh-TW'">
            ...
            <br /><br />
            本研究將透過此網站進行問卷調查，提供您由模型預先生成的影片，並請您比較影片的時間一致性與重新對焦準確度。本問卷共有
    ...
    <div v-if="round === null && !showExample">
      ...
      <div class="scrollable">
        <template v-if="lang === 'zh-TW'">
          ...
          <ul>
            <li>
              資料收集：我們計劃收集100-200名受試者的生成影像或影片評分資料。若有人中途退出或數據無法使用，將遞補至收集完所需受試者為止。
            </li>
          ...
          <br />
          <h3>實驗進行方式</h3>
          您將對預先使用不同方法產生的影片進行個人主觀的品質比較，並評估其時間一致性與是否正確對焦到目標
